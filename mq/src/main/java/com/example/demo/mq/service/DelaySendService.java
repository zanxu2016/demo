...
import com.example.demo.mq.config.RabbitConfig;
import com.example.demo.mq.enums.ErrorCodeEnum;
import com.example.demo.mq.exception.SystemException;
import com.example.demo.mq.utils.Message;
...
public class DelaySendService {
    ...
    public void sendDelayMessage(Message msg) {
        ...
        try {
            ...
            throw new SystemException(ErrorCodeEnum.UNKNOWN_ERROR);
        }
    }
